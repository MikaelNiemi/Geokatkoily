        ...
        case 1:
            return(
                <div>
                    ...
                    <p>Mister Geokätköilijä mietti, että mihin sitä tällä kertaa lähtisi. Hetken mietittyään, hän päätti lähteä <strong>Forssaan</strong>. Forssassa hän vietti päivän kierrellen eri museoissa. Hän ei löytänyt sieltä muuta kiinnostavaa, niin hän päätti siirtyä seuraavaan paikkaan. Pohjois-Karjalassa hän ei aiemmin ole ollut, joten hän päätti suunnistaa seuraavaksi sinnepäin. Kohteeksi valikoitui <strong>Outokumpu</strong>. Hänellä kävi onni, kun hän tapasi Anna Puun Outokummun torilla. Hän oli keskittynyt puhelimeensa, kun hän törmäsi yhtäkkiä Annan selkään. Geokätköilijä pahoitteli ja kehui Annan laulutaitoa. Annalla oli kiire, joten sananvaihto jäi lyhyeen.  Geokätköilijä kyllästyi Outokummun maisemiin ja halusi jo pikaisesti toiseen paikkaan. Hän otti seuraavaksi suunnaksi Pirkanmaan Akaan. <strong>Akaa</strong> ja sen veturimuseo oli Geokätköilijältä kokematta. </p>
                    <p>Yhtäkkiä Geokätköilijälle tuli koti-ikävä ja hän halusi palata kotiin. <strong>Kankaanpää</strong> oli hänen tuttu ja turvallinen kotinsa. Hän tapaili kavereitaan ja unohti hetkeksi kätköilyn. Tätä kului noin viikko, kun taas matkakuume iski. Tällä kertaa hän päätti valita suunnaksi Enonkosken. <strong>Enonkoski</strong> sijaitsi Etelä-Savossa. Siellä voisi kätköillä. Hämärän tullessa voisi mennä seuraamaan Enonkosken Pyrintöä, kun ei Geokätköilijä välittänyt oikein pimeäkätköistä. Etelä-Pohjanmaan puukkojunkkarit kiinnostivat myös Geokätköilijää, siksi hän päätti valita seuraavaksi kohteeksi <strong>Evijärven</strong>. Evijärven Vasikka-ahon markkinat kuulostivat kivoilta, joten sinne heinäkuussa oli kiva matkustaa. Geokätköilijän loma loppuikin heinäkuun viimeisenä sunnuntaina, joten Evijärvi jäisi viimeiseksi kohteeksi.</p>
                </div>
            )
